...
public  class JoinGameFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = (View) inflater.inflate(R.layout.join_game_fragment, container, false);

        // Instance the api
        final JSA_WebAPI myAPI_conn = new JSA_WebAPI();

        // Set up the click events on join to start with the calls to the API
        Button create_game_button = (Button) rootView.findViewById(R.id.join_game_button);
